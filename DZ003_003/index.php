...
<head>
    ...
    <title>Web Servisi - WSDL/SOAP - Zadatak 3</title>
    <style>
        :root{
    ...
    <script>
      function dohvati() {
          ...
          xmlhttp.open("GET", "server.php?bandName=" + str, true);
          xmlhttp.send();
        }
      }
      function dohvati2() {
        ...
        xmlhttp.onreadystatechange = function() {
          if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            document.getElementById("resultDiv2").innerHTML = xmlhttp.responseText;
          }
      }
      xmlhttp.open("GET", "personSearch.php?s=" + str, true);
      xmlhttp.send();
    }
  }
        </script>
        ...
        <div id="desniDiv">
            ...
            <div id="desniMainDiv">
                <div class="bodyDijelovi">
                    <h3> Dohvati informacije o članovima band-a</h3>
                    <p> Molimo upišite naziv band-a</p>
                    ...
                    <h3> Dohvati informacije o osobama</h3>
                    <p> Molimo upišite upit</p>
                    <input type=text id="inputText2"> <button onclick="dohvati2()">Pretraži</button>
                    <div id="resultDiv2" style="margin-top:1rem; margin-bottom:1rem;"></div>
